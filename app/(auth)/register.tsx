...
export default function Register() {
  ...
  const handleRegister = async () => {
    ...
    try {
      ...
      const prof = await signIn(email.trim().toLowerCase(), password);
      if (prof.role === 'facility_manager') router.replace('/(manager)');
      else if (prof.role === 'worker') router.replace('/(worker)');
