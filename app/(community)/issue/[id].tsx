...
export default function IssueDetailScreen() {
  ...
  useEffect(() => {
    async function load() {
      const [issueRes, assignmentRes, historyRes] = await Promise.all([
      ...
      if (assignmentRes.data) setAssignment(assignmentRes.data as unknown as Assignment);
      if (historyRes.data) setHistory(historyRes.data as StatusHistory[]);
      setLoading(false);
    }
    load();
  }, [id]);
